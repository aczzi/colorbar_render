...
def rgb2yuv_10bit(R, G, B, M, N):
    R_ = R.astype("double")
    G_ = G.astype("double")
    B_ = B.astype("double")
    Y = M[0] * R_ + M[1] * G_ + M[2] * B_
    U = (B - Y) / M[3] + (2**N) / 2
    V = (R - Y) / M[4] + (2**N) / 2
    return Y, U, V


def convert_quantization(img, target_type_min, target_type_max, target_type):
    imin = img.min()
    imax = img.max()
...
def rgb2yuv_stdb67_10bit(R, G, B):
    return rgb2yuv_10bit(R, G, B, [0.2627, 0.6780, 0.0593, 1.8814, 1.4746], 10)


def rgb2yuv_bt709_10bit(R, G, B):
    return rgb2yuv_10bit(R, G, B, [0.2126, 0.7152, 0.0722, 1.8556, 1.5748], 10)


def rgb2yuv_bt2020_10bit(R, G, B):
    return rgb2yuv_10bit(R, G, B, [0.2627, 0.6780, 0.0593, 1.8814, 1.4746], 10)


def uhd_rgb_10bit_color_bar():
    ...
    R[0:h2, (c + d + d + d + e + d + d) : (c + d + d + d + e + d + d + d)] = (
        64  # 100% Blue
    )
    R[0:h1, (c + d + d + d + e + d + d + d) : (c + d + d + d + e + d + d + d + c)] = (
        414  # 40% Gray
    )
    ...
    R[h2:h1, (c + d + d + d + e + d + d) : (c + d + d + d + e + d + d + d)] = (
        64  # 75% Blue
    )
    ...
    G[0:h2, (c + d + d + d + e + d + d) : (c + d + d + d + e + d + d + d)] = (
        64  # 100% Blue
    )
    G[0:h1, (c + d + d + d + e + d + d + d) : (c + d + d + d + e + d + d + d + c)] = (
        414  # 40% Gray
    )
    ...
    G[h2:h1, (c + d + d + d + e + d + d) : (c + d + d + d + e + d + d + d)] = (
        64  # 75% Blue
    )
    ...
    B[0:h2, (c + d + d + d + e + d + d) : (c + d + d + d + e + d + d + d)] = (
        940  # 100% Blue
    )
    B[0:h1, (c + d + d + d + e + d + d + d) : (c + d + d + d + e + d + d + d + c)] = (
        414  # 40% Gray
    )
    ...
    B[h2:h1, (c + d + d + d + e + d + d) : (c + d + d + d + e + d + d + d)] = (
        721  # 75% Blue
    )
    ...
    R[h1 : (h1 + h2), (c + d + d + d + int(e / 2)) : (c + d + d + d + e)] = (
        502  # 50% Step
    )
    R[h1 : (h1 + h2), (c + d + d + d + e) : (c + d + d + d + e + int(d / 2))] = (
        590  # 60% Step
    )
    R[h1 : (h1 + h2), (c + d + d + d + e + int(d / 2)) : (c + d + d + d + e + d)] = (
        677  # 70% Step
    )
    R[
        h1 : (h1 + h2), (c + d + d + d + e + d) : (c + d + d + d + e + d + int(d / 2))
    ] = 765  # 80% Step
    R[
        h1 : (h1 + h2),
        (c + d + d + d + e + d + int(d / 2)) : (c + d + d + d + e + d + d),
    ] = 852  # 90% Step
    R[
        h1 : (h1 + h2),
        (c + d + d + d + e + d + d) : (c + d + d + d + e + d + d + int(d / 2)),
    ] = 940  # 100% Step
    R[
        h1 : (h1 + h2),
        (c + d + d + d + e + d + d + int(d / 2)) : (c + d + d + d + e + d + d + d),
    ] = 1019  # 109% Step
    R[
        h1 : (h1 + h2),
        (c + d + d + d + e + d + d + d) : (c + d + d + d + e + d + d + d + c),
    ] = 721  # 75% White
    ...
    G[h1 : (h1 + h2), (c + d + d + d + int(e / 2)) : (c + d + d + d + e)] = (
        502  # 50% Step
    )
    G[h1 : (h1 + h2), (c + d + d + d + e) : (c + d + d + d + e + int(d / 2))] = (
        590  # 60% Step
    )
    G[h1 : (h1 + h2), (c + d + d + d + e + int(d / 2)) : (c + d + d + d + e + d)] = (
        677  # 70% Step
    )
    G[
        h1 : (h1 + h2), (c + d + d + d + e + d) : (c + d + d + d + e + d + int(d / 2))
    ...
    B[h1 : (h1 + h2), (c + d + d + d + int(e / 2)) : (c + d + d + d + e)] = (
        502  # 50% Step
    )
    B[h1 : (h1 + h2), (c + d + d + d + e) : (c + d + d + d + e + int(d / 2))] = (
        590  # 60% Step
    )
    B[h1 : (h1 + h2), (c + d + d + d + e + int(d / 2)) : (c + d + d + d + e + d)] = (
        677  # 70% Step
    )
    B[
        h1 : (h1 + h2), (c + d + d + d + e + d) : (c + d + d + d + e + d + int(d / 2))
    ...
    R[(h1 + h2) : (h1 + h2 + h3), (c + 1118 + 2028) : (c + 1118 + 2028 + 214)] = (
        1019  # Ramp Top
    )
    ...
    G[(h1 + h2) : (h1 + h2 + h3), (c + 1118 + 2028) : (c + 1118 + 2028 + 214)] = (
        1019  # Ramp Top
    )
    ...
    B[(h1 + h2) : (h1 + h2 + h3), (c + 1118 + 2028) : (c + 1118 + 2028 + 214)] = (
        1019  # Ramp Top
    )
    ...
    R[
        (h1 + h2 + h3) : (h1 + h2 + h3 + h4), (int(c / 3)) : (int(c / 3) + int(c / 3))
    ] = 538  # 75% BT.709 Cyan
    R[(h1 + h2 + h3) : (h1 + h2 + h3 + h4), (int(c / 3) + int(c / 3)) : c] = (
        512  # 75% BT.709 Green
    )
    R[(h1 + h2 + h3) : (h1 + h2 + h3 + h4), c : (c + f)] = 64  # 0% Black
    R[(h1 + h2 + h3) : (h1 + h2 + h3 + h4), (c + f) : (c + f + g)] = 48  # -2% Black
    R[(h1 + h2 + h3) : (h1 + h2 + h3 + h4), (c + f + g) : (c + f + g + h)] = (
        64  # 0% Black
    )
    R[(h1 + h2 + h3) : (h1 + h2 + h3 + h4), (c + f + g + h) : (c + f + g + h + g)] = (
        80  # +2% Black
    )
    R[
        (h1 + h2 + h3) : (h1 + h2 + h3 + h4),
        (c + f + g + h + g) : (c + f + g + h + g + h),
    ] = 64  # 0% Black
    R[
        (h1 + h2 + h3) : (h1 + h2 + h3 + h4),
        (c + f + g + h + g + h) : (c + f + g + h + g + h + g),
    ] = 99  # +4% Black
    R[
        (h1 + h2 + h3) : (h1 + h2 + h3 + h4),
        (c + f + g + h + g + h + g) : (c + f + g + h + g + h + g + i),
    ] = 64  # 0% Black
    R[
        (h1 + h2 + h3) : (h1 + h2 + h3 + h4),
        (c + f + g + h + g + h + g + i) : (c + f + g + h + g + h + g + i + j),
    ] = 721  # 75% White
    R[
        (h1 + h2 + h3) : (h1 + h2 + h3 + h4),
        (c + f + g + h + g + h + g + i + j) : (c + f + g + h + g + h + g + i + j + k),
    ] = 64  # 0% Black
    R[
        (h1 + h2 + h3) : (h1 + h2 + h3 + h4),
        (c + f + g + h + g + h + g + i + j + k) : (
            c + f + g + h + g + h + g + i + j + k + int(c / 3)
        ),
    ] = 651  # 75% BT.709 Magenta
    R[
        (h1 + h2 + h3) : (h1 + h2 + h3 + h4),
        (c + f + g + h + g + h + g + i + j + k + int(c / 3)) : (
            c + f + g + h + g + h + g + i + j + k + int(c / 3) + int(c / 3)
        ),
    ] = 639  # 75% BT.709 Red
    R[
        (h1 + h2 + h3) : (h1 + h2 + h3 + h4),
        (c + f + g + h + g + h + g + i + j + k + int(c / 3) + int(c / 3)) : (
            c + f + g + h + g + h + g + i + j + k + c
        ),
    ] = 227  # 75% BT.709 Blue
    ...
    G[(h1 + h2 + h3) : (h1 + h2 + h3 + h4), (int(c / 3) + int(c / 3)) : c] = (
        706  # 75% BT.709 Green
    )
    G[(h1 + h2 + h3) : (h1 + h2 + h3 + h4), c : (c + f)] = 64  # 0% Black
    G[(h1 + h2 + h3) : (h1 + h2 + h3 + h4), (c + f) : (c + f + g)] = 48  # -2% Black
    G[(h1 + h2 + h3) : (h1 + h2 + h3 + h4), (c + f + g) : (c + f + g + h)] = (
        64  # 0% Black
    )
    G[(h1 + h2 + h3) : (h1 + h2 + h3 + h4), (c + f + g + h) : (c + f + g + h + g)] = (
        80  # +2% Black
    )
    G[
        (h1 + h2 + h3) : (h1 + h2 + h3 + h4),
    ...
    B[(h1 + h2 + h3) : (h1 + h2 + h3 + h4), (int(c / 3) + int(c / 3)) : c] = (
        296  # 75% BT.709 Green
    )
    B[(h1 + h2 + h3) : (h1 + h2 + h3 + h4), c : (c + f)] = 64  # 0% Black
    B[(h1 + h2 + h3) : (h1 + h2 + h3 + h4), (c + f) : (c + f + g)] = 48  # -2% Black
    B[(h1 + h2 + h3) : (h1 + h2 + h3 + h4), (c + f + g) : (c + f + g + h)] = (
        64  # 0% Black
    )
    B[(h1 + h2 + h3) : (h1 + h2 + h3 + h4), (c + f + g + h) : (c + f + g + h + g)] = (
        80  # +2% Black
    )
    B[
        (h1 + h2 + h3) : (h1 + h2 + h3 + h4),
...
def main():
    R, G, B = uhd_rgb_10bit_color_bar()
    img = Image.fromarray(convert_quantization(np.dstack((R,G,B)), 0, 255, np.uint8), 'RGB')
    img.save('colorbar.png')
        
    Y, U, V = rgb2yuv_bt2020_10bit(R, G, B)
    YUV10bit = np.stack([Y, U, V], 0).astype("uint16")
    YUV10bit.tofile("yuv444p10le_bt2020_3840x2160.yuv")

    Y, U, V = rgb2yuv_bt709_10bit(R, G, B)
    YUV10bit = np.stack([Y, U, V], 0).astype("uint16")
    YUV10bit.tofile("yuv444p10le_bt709_3840x2160.yuv")

    Y, U, V = rgb2yuv_stdb67_10bit(R, G, B)
    YUV = np.stack([Y, U, V], 0).astype("uint16")
    YUV.tofile("yuv444p10le_std-b72_3840x2160.yuv")

    YUV = convert_quantization(YUV10bit, 0, 255, np.uint8)
    YUV.tofile("yuv444p_bt709_3840x2160.yuv")
